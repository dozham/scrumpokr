- [x] Feature: when the user is entering their name to enter a room, give them the option to choose a random cool name instead (in the context of team and scrum or anything else that is relevant)
